...
SECTIONS = {
    "overview": {
        ...
        "body": lambda: (
            ...
            f"✨ <b>Chemistry runs {chemistry.SQUAD_BASE}-"
            f"{chemistry.CMUCHEM_TOTAL_MAX}</b>\n"
            f"Every XI turns up and plays, so you always start on a "
            f"<b>{chemistry.SQUAD_BASE} Squad Base</b>. The "
            f"{chemistry.EARNED_MAX} points above that are earned:\n\n"
            "<b>Where the earned points come from</b>\n"
            ...
            f"━━━━━━━━━━━━━━━━━━━\n"
            f"<b>{chemistry.CHEMISTRY_POINTS_MAX} points → "
            f"{chemistry.EARNED_MAX} earned</b>\n"
            f"<code>{chemistry.SQUAD_BASE} base + "
            f"{chemistry.EARNED_MAX} earned = "
            f"{chemistry.CMUCHEM_TOTAL_MAX}</code>\n\n"
            "<b>🎨 Colour key</b>\n"
            f"{_colour_key()}\n\n"
