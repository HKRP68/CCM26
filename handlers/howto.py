...
SECTIONS = {
    "game": {
        ...
        "body": (
            ...
            "scorecard + commentary in seconds (no tapping). One sim every "
            "4 hours; reply to a player to sim your XI against theirs, which "
            "spends both sides' cooldowns\n\n"
            "<b>The flow:</b>\n"
            ...
            "<b>📍 Pitches matter</b>\n"
            "• <b>Dusty / Dry</b> — turners; spin rules, boundaries dry up\n"
            "• <b>Green</b> — seam and swing; nick off or cash in\n"
            "• <b>Bouncy</b> — express pace bites, but timing carries\n"
            "• <b>Even</b> — neutral; bat and ball share the honours\n"
            "• <b>Hard / Flat</b> — carry and no movement, a batters' paradise\n"
            "Pitches <b>wear down</b> over the match, each in its own way — a "
            "turner's footmarks deepen while a green top flattens out — so the "
            "2nd innings plays differently. /matchhelp has every surface.\n\n"
            "<b>⭐ Form matters</b>\n"
            "Each player's last 5 matches affect their effective rating (±2.5 OVR). Hot players hit harder; cold players struggle.\n\n"
            "<b>💎 Traits</b>\n"
            "Equipped traits activate during matches under certain conditions (death overs, chasing, vs spin, a 50+ partnership, the tail, a hot streak…). Watch for the 💎 line in scorecards, and see /traitlist for every effect.\n"
            "They also lift your <b>Team Overall</b> — ⚡ +0.2 at Lv.1 doubling to +3.2 at Lv.5, shown on the Playing XI card before the toss and on the live board. Check your own with /traitboost.\n\n"
            "<b>🤖 If you go AFK</b>\n"
    ...
    "squad": {
        ...
        "body": (
            ...
            "<b>/gspin</b> (or <b>/gs</b>) — Lucky Card Pick: one of five cards, for coins, gems, or rare players\n"
            ...
            "<b>/setteamlogo</b> — set your team crest. Send it to the bot in a "
            "private chat as a <b>PNG file</b> (not a photo — Telegram "
            "compresses those and loses the transparent background). A bot "
            "admin checks it before it appears on your scorecards, and you are "
            "told either way.\n"
            "<b>/setteamcolour &lt;#hex&gt;</b> — your team's colour on every "
            "scorecard. A hex code like <code>#aa001b</code> or a name like "
            "<code>crimson</code>. Applies straight away.\n\n"
            ...
            "<b>/releasemultiple &lt;from&gt; &lt;to&gt;</b> (or <b>/rm</b>) — release "
            "a position range\n"
            "<i>Both take the numbers shown on /myroster and /pxi — 1-11 is "
            "your XI, 12+ is the bench.</i>\n\n"
    ...
    "economy": {
        ...
        "body": (
            ...
            "<b>/traitshop</b> — buy traits with gems (150💎 Common → 1,200💎 Elite)\n"
            "<b>/trade</b> — peer-to-peer player trades\n\n"
            "<b>💎 Traits (gem economy)</b>\n"
            "<b>/traits</b> — view your active player-traits\n"
            "<b>/traitboost</b> — ⚡ what your traits add to your XI's Team Overall\n"
            "<b>/traitlist</b> — the full catalogue: every effect and price\n"
            "<b>/traitshop</b> — buy new traits (unlimited stock, restocks daily)\n"
            ...
            "A trait's value is what it cost to build — 150💎 for a Common Lv.1 "
            "plus every upgrade on top (Lv.5 = 3,050💎). Rarer traits cost more "
            "up front (⚪ ×1, 🔵 ×2, 🟣 ×4, ⭐ ×8) and are worth more back.\n"
            f"• <b>/selltrait</b> pays just under what the trait cost you: "
            f"{TRAIT_SELL_TABLE}💎 for a Common Lv.1→5\n"
            "• <b>/tradetrait</b> swaps two traits of the <b>same level and "
            "rarity</b>, and "
            f"each side pays {TRAIT_FEE_TABLE}💎 for a Common Lv.1→5\n"
