...
BOT_MENU_COMMANDS = (
    ...
    ("cmuchest", "Open your coin chests (Platinum/Diamond) 🪙"),
    ...
    ("resume", "Resume your active match (same as /rcl) — /resume <MatchId> works too"),
    ("rcl", "Resume a stuck Challenge League / Lets Play match — /rcl <MatchId>"),
    ...
    ("lptstats", "Lets Play Tournament leaderboards"),
